...
<b>- لــ تـشـغـيل الـسـوره فـي الـمكـالـمـة الـصـوتـيـة</b>

فيديو + (اسم المقـطـع / رابط المقـطـع)
<b>- لــ تـشـغـيل فيـديـو فـي الـمكـالـمـة المـرئيـة</b>

بحث + الاسـم
<b>- لـ تحميـل الـقـران والمقـاطـع الصوتيـه مـن اليوتيـوب</b>
...
ايقاف / انهاء / اسكت
<b>- لـ إيقـاف تـشغـيـل الــســورة فـي المكـالمـة</b>

وقف / توقف
<b>- لـ إيقـاف تشغيـل الــســورة فـي المكالمـة مـؤقتـاً</b>

كمل / كملي
<b>- لـ إسـتـئـنـاف تـشغـيـل الــســورة فـي المكـالمـة</b>

تخطي
<b>- لـ تخطـي الــســورة وتشغيـل الــســورة التاليـه</b>

القران
<b>- لـ معـرفـة الــســورة المـوجـودة فـي قائمـة الانتظـار</b>
...
ٴ⋆┄─┄─┄─┄─┄─┄─┄─┄⋆
تشغيل + اسم الســورة
<b>- لــ تـشـغـيل الــســورة فـي الـمكـالـمـة الـصـوتـيـة</b>
...
ٴ⋆┄─┄─┄─┄─┄─┄─┄─┄⋆
/seek + عـدد الثـوانـي
<b>- لـ تقديـم الــســورة لـ الامـام</b>
/seekback + عـدد الثـوانـي
<b>- لـ إرجـاع الــســورة لـ الخـلف</b>
""",
       reply_markup=InlineKeyboardMarkup(
          [
               [
...
<b>- لـ حظـر/الغـاء حظـر شخـص من استخـدام الـقـران البـوت</b>

احظره عام/الغاء حظره عام
<b>- لـ حظـر/الغـاء حظـر شخـص من استخـدام الـقـران البـوت عـام</b>

المحظورين عام
<b>- لـ جلب قائمـة المحظـورين عـام فـي البـوت</b>

حظر مجموعة/سماح
<b>- لـ حظـر/الغـاء حظـر مجموعـة من استخـدام الـقـران البـوت</b>
...
<b>- لـ تفعيـل/تعطيـل المغـادره التلقائيـه لـ الحسـاب المسـاعـد مـن المجمـوعـات عنـد عـدم استـخـدام الــقــران</b>
